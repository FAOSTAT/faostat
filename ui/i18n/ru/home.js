...
define(['jquery', 'i18n!nls/common'], function ($, Common) {
    ...
    return $.extend(true, {}, Common, {
        ...
        database_description_text:"Включает основную информацию о массивах данных и ссылки для пакетной загрузки файлов.",
        ...
        fao_food_security: "Положение дел в области продовольственной безопасности и питания в мире 2018",
