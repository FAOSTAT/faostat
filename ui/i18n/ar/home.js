...
define(['jquery', 'i18n!nls/common'], function ($, Common) {
    ...
    return $.extend(true, {}, Common, {
        ...
        database_description:"وصف قاعدة البيانات ",
        database_description_text:"تتضمن معلومات أساسية عن مجموعات البيانات وروابط بفرادى الملفات لتنزيلها بمقادير كبيرة.",
